...
void generate_result()
{
	...
	{
		cout<<"Voter X is the winner\nWith "<<voterX<<" votes"<<endl;
		cout<<"Voters of Y are "<<voterY<<" \nVoters of Z are "<<voterZ<<endl;
	}
	else if(voterY>voterX&&voterY>voterZ)
	{
		cout<<"Voter Y is the winner\nWith "<<voterY<<" votes"<<endl;
		cout<<"Voters of X are "<<voterX<<" \nVoters of Z are "<<voterZ<<endl;
	}
	else if(voterZ>voterX&&voterZ>voterY)
	{
		cout<<"Voter Z is the winner\nWith "<<voterZ<<" votes"<<endl;
		cout<<"Voters of X are "<<voterX<<" \nVoters of Y are "<<voterY<<endl;
	}
